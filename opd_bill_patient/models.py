...
class OpdBillPatient(models.Model):
    patient = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="patient_to_be_billed"
    )
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="opd_bill_patient_user"
    )
