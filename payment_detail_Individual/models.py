...
class PaymentDetailIndividual(models.Model):
    payment = models.ForeignKey(
        PaymentIndividual,
        on_delete=models.CASCADE,
        related_name="payment_in_PaymentIndividual_detail",
    )
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="payment_detail_PaymentIndividual"
    )
