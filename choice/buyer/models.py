...
class Buyer(models.Model):
    ...
    country = models.ForeignKey(
        "nation.Nation", on_delete=models.CASCADE, related_name="buyer_country"
    )
    region = models.ForeignKey(
        ...
        null=True,
        blank=True,
        related_name="buyer_region",
    )
    district = models.ForeignKey(
        "district.District", on_delete=models.CASCADE, related_name="buyer_district"
    )
    town = models.ForeignKey(
        "town.Town", on_delete=models.CASCADE, related_name="buyer_town"
    )
    ...
    created_by = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name="buyer_quantity_user"
    )
